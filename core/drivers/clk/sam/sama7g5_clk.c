...
static const struct sam_clk sama7g5_systemck[] = {
	{ .n = "pck0",  .id = 8 },
	{ .n = "pck1",  .id = 9 },
	{ .n = "pck2",  .id = 10 },
	{ .n = "pck3",  .id = 8 },
			    ...
			    const void *data __unused)
{
	...
	/* This array order must match the one in sama7g5_systemck */
	parents[0] = mckdivck;
	parents[1] = mckdivck;
	parents[2] = usbck;
	parents[3] = usbck;
...
CLK_DT_DECLARE(sama5d2_clk, "atmel,sama7g5-pmc", pmc_setup_sama7g5);